                    ...
                    <div className="container px-5 py-12 mx-auto">
                        <div className="lg:w-4/5 mx-auto flex flex-wrap">
                            ...
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex">
                                    <Link className="flex mt-10 rounded-full text-white bg-blue-700 border py-2 px-6 focus:outline-none hover:bg-blue-500" to="/Borrow">Borrow</Link>
                                    <Link className="flex mt-10 ml-6 text-gray-700 bg-white border border-gray-700 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded-full">Chat</Link>
                                </div>
                            </div>
                        </div>
                    </div>
