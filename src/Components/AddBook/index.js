            ...
            <div className="w-9/12 ml-80 bg-white -mt-6">
                <div className="p-4 text-gray-500">
                    <section className="text-gray-600 body-font">
                        <span className="inline-block font-semibold text-2xl text-gray-700 ml-12 lg:ml-12 md:ml-12 sm:ml-8 pb-2 mt-3">Update Books</span>
                        <div className="container mx-auto flex px-5 items-center justify-center flex-col">
                            <div className="lg:w-4/5 md:w-1/2 bg-white flex flex-col w-full md:py-8 mt-8 md:mt-0">
                                ...
                                <div className="flex">
                                    <button className="ml-auto mr-20 bg-plugin px-6 rounded-full py-2 text-white">Add Book</button>
                                </div>
                            </div>
                        </div>
                    </section>
