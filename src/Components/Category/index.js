...
export default class Category extends Component {
    render() {
        return (
            <div>
                <div className="bg-white rounded p-3 mt-24 overflow-x-hidden">
                        <span className="inline-block font-semibold text-xl text-gray-700 ml-5 lg:ml-20 md:ml-12 sm:ml-8 pb-4">Technology</span>
